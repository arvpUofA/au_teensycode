...
Running_Average<uint32_t, SAMPLES_PER_SECOND> avg_pressure;
Running_Average<float, SAMPLES_PER_SECOND> avg_temperature;
Running_Average<float, SAMPLES_PER_SECOND> avg_humidity;
...
float publishPress() {
    return (float) avg_pressure.Average();
}
